...
const ENTRY_META = [
  {
    ...
    accentSoft: "rgba(138,90,82,0.12)",
    badge: "Current",
  ...
  },
  {
    ...
    accentSoft: "rgba(111,143,124,0.12)",
    badge: "Completed",
    ...
    <div className={`relative flex w-full ${isLeft ? "justify-start" : "justify-end"}`}>
      ...
      <div className="absolute left-1/2 top-10 -translate-x-1/2 z-20 flex flex-col items-center">
        <motion.div
          ...
          style={{
            background: `linear-gradient(135deg, ${meta.accent}, var(--color-accent-amber))`,
      ...
      >
        ...
        <motion.div
          ...
          style={{ background: `linear-gradient(90deg, ${meta.accent}, var(--color-accent-amber))` }}
        ...
        {entry.gpa && (
          <motion.div
            ...
            style={{ background: `linear-gradient(135deg, var(--color-accent-amber), var(--color-accent-pink))` }}
          >
    ...
    <section id="journey" className="relative overflow-hidden py-20 sm:py-28">
      ...
      <Container className="flex flex-col gap-12">
        ...
        <div ref={timelineRef} className="relative hidden sm:block">
          ...
          <motion.div
            style={{ scaleY: lineScale, opacity: lineGlow }}
            className="absolute left-1/2 top-0 bottom-0 w-[2px] -translate-x-1/2 origin-top bg-gradient-aurora"
          />
              ...
              >
                ...
                <div className="flex items-center gap-3 mb-3">
                  <div className="h-9 w-9 rounded-full flex items-center justify-center text-base shrink-0"
                    style={{ background: `linear-gradient(135deg, ${meta.accent}, var(--color-accent-amber))` }}>
                    {meta.emoji}
                  </div>
                  <div>
                ...
                {entry.gpa && (
                  <p className="mt-3 inline-flex items-center gap-2 rounded-full border border-accent-amber/40 bg-accent-amber/10 px-2.5 py-0.5 text-[11px] font-bold text-accent-amber">
                    ⭐ GPA {entry.gpa}
                  </p>
                )}
              </motion.div>
